...
La etapa consulta la [API pública del Banco Mundial](https://datahelpdesk.worldbank.org/knowledgebase/articles/889392) usando el código ISO alpha-3 que el modelo haya extraído del documento de identidad. El resultado se guarda en `external_validation.json`; no valida la identidad, pagos ni historial académico del estudiante.
